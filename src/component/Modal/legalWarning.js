                    ...
                    <Box sx={{ height: "100%", p: 1, background: "#f5f5f5" }}>
                        <Box sx={{
                            ...
                            <Box component="ul" sx={{ overflowY: "auto", height: "90%", listStyle: "none" }}>
                                ...
                                <Typography pb={1}>De acuerdo con lo establecido en la normativa de protección de datos, le informamos de que los datos personales que nos facilite a través de nuestro sitio web o mediante envíos de correos electrónicos, serán tratados por ALTEL COMUNICACIONES XXI SL en su calidad de responsable del tratamiento, bajo la legitimidad otorgada por el consentimiento prestado por el usuario para las finalidades descritas en la política de privacidad, la cual debe ser leída, comprendida y aceptada para la utilización del presente portal web.</Typography>
                                <Typography pb={1}>El usuario responderá, en cualquier caso, de la veracidad de los datos facilitados y podrá ejercitar los derechos de acceso, supresión, rectificación, oposición, limitación del tratamiento y portabilidad, mediante escrito dirigido a la empresa, bien a su domicilio social, bien a través de correo electrónico a info@hartodepagar.com siempre y cuando acredite su identidad. Y en el caso de que lo estime oportuno, podrá acudir a la Agencia Española de Protección de Datos.</Typography>
