...
function UploadData() {
  ...
  const handleDownload = async () => {
    ...
    const data = {
      downloadType:
        download === "all_document" || download === "all_record"
          ? "multiple"
          : "single",
      type:
        download === "all_document" || download === "one_document"
          ? "pdf"
          : "csv",
  ...
  const handleDragBlacklist = (e) => {
    e.preventDefault();
    e.stopPropagation();
  };

  const handleDropBlacklist = (e) => {
    e.preventDefault();
    e.stopPropagation();
    if (e.dataTransfer.files && e.dataTransfer.files.length > 0) {
      setBlacklistFile(e.dataTransfer.files[0]);
      e.dataTransfer.clearData();
    }
  };
              ...
              >
                ...
                >
                  ...
                  <Grid sx={{ height: "100%" }} container>
                    ...
                    <Grid sx={{ position: "relative" }} item xs={12} md={7}>
                      <Box
                        sx={{
                          position: { md: "absolute", xs: "relative" },
                          top: { md: "50%", xs: 0 },
                  ...
                  >
                    ...
                    >
                      <Grid item xs={12} md={5}>
                        ...
                        >
                          <MenuItem value={"all_document"}>
                            Descargar todos los documentos
                          </MenuItem>
                          <MenuItem value={"one_document"}>
                            Descargar solo un documento
                          </MenuItem>
                          <MenuItem value={"all_record"}>
                            Descargar todos los registros
                          </MenuItem>
                          <MenuItem value={"one_records"}>
                            Descargar solo un registro
                          </MenuItem>
                        </TextField>
                      </Grid>
                      <Grid item xs={12} md={3}>
